...
public class MixedResults {
  ...
  public static void main( String[] args ) {
    ...
    System.out.println( (int)(3.0 + 5)/(2 + 5.0) * 2 - 3 ); // -.7142857142857144
    ...
    System.out.println( "Problem 2: " + (57.2 * ((double)i1/i2) + 1)); // 39.13333333333333333
    System.out.println( "Problem 3: " + (15 - i1 * ( d1 * 3 ) + 4) ); // -1345.39999999999999999
     ...
     * Math.asin(x);        = arcsing of x in range -PI/2 to PI/2
     * Math.acos(x);        = arccosine of x in range -PI/2 to PI/2
     * Math.atan(x);        = arctan of x in rage -PI/2 to PI/2
     * Math.toDegress(x);   = converts radians to degrees
     ...
     * Project: ComputeThis
     * 
     * Print: d1 = 3PIsin(187) + |cos(122deg)| = -0.618672237
